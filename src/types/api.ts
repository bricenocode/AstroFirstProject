// To parse this data:
//
//   import { Convert, SpaceAPISpaceXResponse } from "./file";
//
//   const spaceAPISpaceXResponse = Convert.toSpaceAPISpaceXResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SpaceAPISpaceXResponse {
  docs:          Doc[];
  totalDocs:     number;
  offset:        number;
  limit:         number;
...
export class Convert {
  public static toSpaceAPISpaceXResponse(json: string): SpaceAPISpaceXResponse {
      return cast(JSON.parse(json), r("SpaceAPISpaceXResponse"));
  }

  public static spaceAPISpaceXResponseToJson(value: SpaceAPISpaceXResponse): string {
      return JSON.stringify(uncast(value, r("SpaceAPISpaceXResponse")), null, 2);
  }
}
